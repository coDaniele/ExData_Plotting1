...
#subpart 1, topleft
plot(hh$hh1, hh$Global_active_power, pch=".", xlab="", 
     ylab="Global Active Power")
lines(hh$hh1, hh$Global_active_power, lwd=1)

#subpart 2, topright
plot(hh$hh1, hh$Voltage, pch=".", xlab="datetime", 
     ylab="Voltage")
lines(hh$hh1, hh$Voltage, lwd = 1)

#subpart 3, bottomleft
plot(hh$hh1, hh$Sub_metering_1, pch=".", xlab="", 
     ylab="Energy sub metering")
lines(hh$hh1, hh$Sub_metering_1, lwd=1)
lines(hh$hh1, hh$Sub_metering_2, col="Red")
lines(hh$hh1, hh$Sub_metering_3, col="Blue")
...
plot(hh$hh1, hh$Global_reactive_power, pch=".", xlab="datetime", 
     ylab="Global_reactive_power")
lines(hh$hh1, hh$Global_reactive_power, lwd=1)
